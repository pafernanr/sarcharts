...
class Conf:
    ...
    charts = {"cpu": {"arg": "-P ALL", "multiple": True, "datasets": {},
              ...
              "netipe": {"arg": "-n EIP", "multiple": True, "datasets": {},
                         "labels": [], "hidden": []},
              "netip6": {"arg": "-n IP6", "multiple": True, "datasets": {},
                         "labels": [], "hidden": []},
              "netip6e": {"arg": "-n EIP6", "multiple": True, "datasets": {},
                          "labels": [], "hidden": []},
              "netnfs": {"arg": "-n NFS", "multiple": False, "datasets": {},
                         "labels": [], "hidden": []},
              "netsock": {"arg": "-n SOCK", "multiple": True, "datasets": {},
                          "labels": [], "hidden": []},
              "netsock6": {"arg": "-n SOCK6", "multiple": True, "datasets": {},
                           "labels": [], "hidden": []},
